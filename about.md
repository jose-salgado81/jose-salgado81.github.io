...
<div class="thumbnail-container">
  <img src="workspace_large.jpg" alt="Remote work station and dog" class="thumbnail" onclick="expandImage(this)">
</div>
...
<style>
.thumbnail {
  width: 150px; /* Set your desired thumbnail width */
  height: auto;
  cursor: pointer;
...
.thumbnail.expanded {
  width: 100%; /* Make the image expand to full width */
}
</style>
