...
A more refined (and recent) presentation of the same concepts can be found in the video series by Abdul Zedan: [Azure OpenAI 101: An introduction to Building Custom AI Models]([https://www.youtube.com/watch?v=0wqjKb60f2Q&t=181s](https://youtu.be/0wqjKb60f2Q?si=mIROK0TUEJ1x6nNw)
